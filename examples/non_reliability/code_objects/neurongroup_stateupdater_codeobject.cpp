...
const size_t _numx = 24;
    ...
    const double _lio_3 = 1.0f*1.0/tau;
    const double _lio_4 = 1.0f*1.1/tau;
    const double _lio_5 = 1.4142135623731 * (sigma * (_brian_pow(1.0f*1.0/tau, 0.5)));
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        if(!not_refractory)
            ...
            _x = ((dt * (_lio_4 + (_lio_3 * (- x)))) + (_lio_5 * xi)) + x;
        if(not_refractory)
            x = _x;
