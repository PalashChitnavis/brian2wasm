...
void _run_neurongroup_spike_thresholder_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    const int64_t N = 24;
const size_t _num_spikespace = 25;
const size_t _numlastspike = 24;
const size_t _numnot_refractory = 24;
const size_t _numt = 1;
const size_t _numx = 24;
    ///// POINTERS ////////////
    ...
    for(size_t _idx=0; _idx<N; _idx++)
    {
        ...
        const double x = _ptr_array_neurongroup_x[_idx];
        char _cond;
        if(!not_refractory)
            _cond = (x > 1) && false;
        else 
