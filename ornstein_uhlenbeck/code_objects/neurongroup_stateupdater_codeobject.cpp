...
const size_t _numsigma = 1;
const size_t _numtau = 1;
const size_t _numy = 1;
    ///// POINTERS ////////////
        
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    double*   _ptr_array_neurongroup_sigma = _array_neurongroup_sigma;
    double*   _ptr_array_neurongroup_tau = _array_neurongroup_tau;
    double*   _ptr_array_neurongroup_y = _array_neurongroup_y;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double sigma = _ptr_array_neurongroup_sigma[_idx];
        ...
        const double _y = ((1.0f*(_lio_2 * y)/tau) + (xi * sqrt(1.0f*(2.0 * (_brian_pow(sigma, 2)))/tau))) + y;
        y = _y;
